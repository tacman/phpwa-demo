...
## —— Symfony 🎵 ———————————————————————————————————————————————————————————————
php: ## Run php, pass the parameter "c=" to run a given command, example: make php c='bin/console about'
	@$(eval c ?=)
	@$(PHP) $(c)
...
messenger: ##
	@$(SYMFONY) messenger:consume scheduler_default async failed -v
